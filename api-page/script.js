document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    setContent("page", "textContent", settings.name, "Bruh Api's")
    setContent(
      "wm",
      "textContent",
      `© ${currentYear} ${settings.apiSettings?.creator || "Asep-Team"}. All rights reserved.`,
    )
    setContent("header", "textContent", settings.name, "Rest Api")
    setContent("name", "textContent", settings.name, "Asep Api's")
